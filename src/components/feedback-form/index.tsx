...
import {ControlledTextField} from "../text-field/ControlledTextField";
...
export function FeedbackForm ({ isOpen, handleContentClick, closeFormModal }: Readonly<FeedbackFormProps>) {
    ...
    return (
        <button className={clsx(s.login_box, isOpen && s.active,submitted && s.submitted)} onClick={handleContentClick}>
        {submitted ? (
